...
<body>
	...
	<form class="form-horizontal" id="tranForm" action="${pageContext.request.contextPath}/workbench/transaction/save.do" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="c6210158fe084118b8f16ee573e6c59f">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="08cc91288417449fb07952e43671b838">
			</div>
		</div>
